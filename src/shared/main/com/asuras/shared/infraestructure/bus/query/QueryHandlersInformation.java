...
import com.asuras.shared.domain.bus.query.QueryHandler;
import com.asuras.shared.domain.bus.query.QueryNotRegisteredError;
...
public final class QueryHandlersInformation {
    ...
    public QueryHandlersInformation() {
        Reflections                        reflections = new Reflections("com.asuras");
